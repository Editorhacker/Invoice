...
const SignupPage: React.FC<SignupPageProps> = ({ onSignup, onSwitchToLogin, onSwitchToHome }) => {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-deep-purple flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
          Or{' '}
          <button onClick={onSwitchToLogin} className="font-medium text-muted-magenta hover:text-dusty-pink">
